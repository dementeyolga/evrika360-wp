(function () {
  ...
  const featurePriceSliderViewportNode =
    featurePriceSliderEmblaNode?.querySelector(
      ".feature-price-embla__viewport",
    );
  const featurePriceSliderPrevBtnNode =
    featurePriceSliderEmblaNode?.querySelector(
      ".feature-price-embla__button--prev",
    );
  const featurePriceSliderNextBtnNode =
    featurePriceSliderEmblaNode?.querySelector(
  ...
  if (featurePriceSliderViewportNode && featurePriceSliderOptions) {
    ...
    const featurePriceSliderAddPrevNextBtnsClickHandlers = (
      ...
      if (emblaApi && prevBtn && nextBtn) {
        ...
        const removeTogglePrevNextBtnsActive =
          featurePriceSliderAddTogglePrevNextBtnsActive(
            emblaApi,
            prevBtn,
            nextBtn,
          );
    ...
    const featurePriceSliderAddDotBtnsAndClickHandlers = (
      emblaApi,
      dotsNode,
    ) => {
