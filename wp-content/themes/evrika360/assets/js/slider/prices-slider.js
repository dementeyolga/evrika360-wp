(function () {
  ...
  if (pricesSliderViewportNode && pricesSliderOptions) {
    ...
    const pricesSliderAddDotBtnsAndClickHandlers = (emblaApi, dotsNode) => {
      if (emblaApi && dotsNode) {
        ...
        const addDotBtnsWithClickHandlers = () => {
          ...
          dotNodes = Array.from(
            dotsNode.querySelectorAll(".prices-embla__dot"),
          );
    ...
    pricesSliderEmblaApi?.on(
      "destroy",
      pricesSliderRemovePrevNextBtnsClickHandlers,
    );
    pricesSliderEmblaApi?.on(
      "destroy",
      pricesSliderRemoveDotBtnsAndClickHandlers,
    );
  }
})();
